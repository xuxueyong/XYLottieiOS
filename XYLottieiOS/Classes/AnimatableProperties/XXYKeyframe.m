...
- (instancetype)initWithXXYKeyframe:(XXYKeyframe *)keyframe {
  self = [super init];
  if (self) {
...
- (XXYKeyframe *)copyWithData:(id)data {
  XXYKeyframe *newFrame = [[XXYKeyframe alloc] initWithXXYKeyframe:self];
...
- (void)setupOutputWithData:(id)data {
  ...
  if ([data isKindOfClass:[NSArray class]] &&
    ...
    _pathData = [[XXYBezierData alloc] initWithData:[(NSArray *)data firstObject]];
  } else if ([data isKindOfClass:[NSDictionary class]]) {
    _pathData = [[XXYBezierData alloc] initWithData:data];
  }
}
...
@implementation XXYKeyframeGroup
...
- (void)buildKeyframesFromData:(id)data {
  if ([data isKindOfClass:[NSArray class]] &&
    ...
    for (NSDictionary *keyframe in keyframes) {
      ...
      XXYKeyframe *key = [[XXYKeyframe alloc] initWithKeyframe:currentFrame];
      [keys addObject:key];
    ...
    XXYKeyframe *key = [[XXYKeyframe alloc] initWithValue:data];
    _keyframes = @[key];
  }
}

- (void)remapKeyframesWithBlock:(CGFloat (^)(CGFloat))remapBlock {
  for (XXYKeyframe *keyframe in _keyframes) {
