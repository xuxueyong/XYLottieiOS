...
- (void)initializeData:(NSDictionary *)bezierData {
  ...
  NSAssert((pointsArray.count == inTangents.count &&
           ...
           @"XXYtie: Incorrect number of points and tangents");
  ...
  for (int i = 0; i < pointsArray.count; i ++) {
    ...
    CGPoint outTan = XXY_PointAddedToPoint(vertex, [self _vertexAtIndex:i inArray:outTangents]);
    CGPoint inTan = XXY_PointAddedToPoint(vertex, [self _vertexAtIndex:i inArray:inTangents]);
