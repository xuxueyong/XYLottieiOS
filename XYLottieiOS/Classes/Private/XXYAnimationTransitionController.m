//
//  XXYAnimationTransitionController.m
//  XXYtie
//
...
@implementation XXYAnimationTransitionController {
  XXYAnimationView *tranistionAnimationView_;
...
- (instancetype)initWithAnimationNamed:(NSString *)animation
  ...
  self = [super init];
  if (self) {
    tranistionAnimationView_ = [XXYAnimationView animationNamed:animation inBundle:bundle];
