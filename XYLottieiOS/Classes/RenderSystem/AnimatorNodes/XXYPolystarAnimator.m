...
@implementation XXYPolystarAnimator {
  XXYNumberInterpolator *_outerRadiusInterpolator;
  XXYNumberInterpolator *_innerRadiusInterpolator;
  XXYNumberInterpolator *_outerRoundnessInterpolator;
  XXYNumberInterpolator *_innerRoundnessInterpolator;
...
- (instancetype _Nonnull)initWithInputNode:(XXYAnimatorNode *_Nullable)inputNode
  ...
  if (self) {
    ...
    _innerRadiusInterpolator = [[XXYNumberInterpolator alloc] initWithKeyframes:shapeStar.innerRadius.keyframes];
    _outerRoundnessInterpolator = [[XXYNumberInterpolator alloc] initWithKeyframes:shapeStar.outerRoundness.keyframes];
    _innerRoundnessInterpolator = [[XXYNumberInterpolator alloc] initWithKeyframes:shapeStar.innerRoundness.keyframes];
