...
@interface XXYAnimatorNode : NSObject
...
@property (nonatomic, readonly, strong) XXYAnimatorNode * _Nullable inputNode;

/// This nodes path in local object space
@property (nonatomic, strong) XXYBezierPath * _Nonnull localPath;
/// The sum of all paths in the tree including this node
@property (nonatomic, strong) XXYBezierPath * _Nonnull outputPath;
